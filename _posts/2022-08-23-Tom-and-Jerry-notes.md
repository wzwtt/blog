...
**仙女棒** 武器 8/2/2
- 仙女鼠赐予所有友方老鼠通过攻击敌方获得星星的能力，同时在学习技能后仙女鼠会随着时间增加自动收集星星（ 8 秒/颗）最多 9 颗，敌方猫可攻击带有星星的老鼠来夺取他的星星，仙女鼠挥动仙女棒，根据所选的星星数量消耗附近友方和自己的星星，对命中的友方或敌人造成不同的效果。（注：仙女鼠头顶的星星会由自己的星星数+附近队友的星星数进行组合显示）
```
1 星：对碰触的 1 名友方短时隐身，对碰触的敌方减少健康值和移动速度。

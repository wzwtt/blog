...
**国王战旗** 第二武器 15/8/8
- 国王可召唤不同的战旗，为碰触的友方提供不同的增益，但战旗和增益效果的持续时间较短，当战旗碰触过2次后，战旗将获得强化提供强化版增益，同一时间游戏内只能存在1种战旗，获得战旗效果后的一段时间内无法再次获得同等级的效果。
...
- 勇气冲刺在短时间内击中猫味5次后，能使猫味眩晕并受到额外的伤害。
- 勇气冲刺在短时间内击中猫味3次后，能使猫味眩晕并受到额外的伤害。
...
**剑客长枪** 第二武器 8/8/8
- 剑客泰菲可通过蓄力投掷长枪，蓄力时间越长，投掷的速度越快，距离越长，对碰触的敌人造成敌方造成不同的伤害和控制效果。在投掷后的一定时间内，可再次点击技能使长枪将剑客泰菲拉到尾部跟随飞行，长枪碰到队友后，可携带1名友方进行飞行，期间剑客泰菲和友方均可通过跳跃、投掷离开，若飞行中碰触到易碎道具和打开的老鼠夹，也会挂着该道具飞行，长枪在碰到墙壁，地面，平台时将消失。
- 速度大幅提亮，在勇气释放过程中，长枪命中敌人时将使其无法使用技能，带飞友方时将解除受伤和虚弱状态。
- 在勇气释放过程使用剑客长枪，将减少大量冷却时间。

### 牛仔杰瑞
**仙人掌** 主动技能 15/15/15
- 放置仙人掌，猫踩中仙人掌后会陷入短暂的硬直，还会因为仙人掌的尖刺扎入脚中而受到持续的减速和伤害（效果最多叠加3层)，所有老鼠不受仙人掌的影响，仙人掌持续一段时间后消失。
- 最多可存储2个仙人掌。仙人掌被踩中后会分裂为3个小仙人掌，猫踩中小仙人掌也会陷入短暂的硬直，随后受到持续的减速和伤害（效果最多叠加3层）。仙人掌造成的减速和伤害效果加强，减速效果持续时间长。
...
### 恶魔泰菲
**意念控制** 主动技能 9/7/5
- 恶魔泰菲能够吸引附近1个投掷道具并让其跟随在自己身边，再次使用技能可将道具投掷出去。
- 恶魔泰菲能够吸引2个投掷道具，吸引道具跟随自己的时间变得更长，技能冷却时间降低。
- 恶魔泰菲能够吸引3个投掷道具，技能冷却时间降低。

**黑暗印记** 被动技能 0/0/0
- 恶魔泰菲每隔一段时间会获得黑暗印记，印记的叠加层数最多为 1 层。如果恶魔泰菲被猫攻击或者投掷道具命中会立刻获得 1 层黑暗印记，攻击或者投掷道具命中猫则会立刻移除 1 层印记。当恶魔泰菲身上存在1层印记时，会获得移动速度提升的效果。
- 印记的叠加层数最高为2层，当恶魔泰菲身上存在2层印记时，会获得持续恢复健康值的效果。
...
- 当自己使用道具命中敌方时获得短暂的无敌效果，无敌效果有45秒的冷却时间。
- 当自己使用道具命中受到技能“御风剑舞”或“幻影剑气”影响的敌方时，会对敌方额外造成眩晕效果，敌方在45秒内不会重复受到此效果的影响。
...
### 玛丽
**贵族礼仪** 主动技能 25/15/15
- 玛丽优雅行礼，范围内敌人受其高贵气质感染，无法做出失礼举动， 3 秒内无法攻击（20秒内不会重复触发）。受影响的敌方单位还会从隐身状态中脱离。
- 大幅度减少冷却时间。
- 目标被玛丽优雅姿态惊得目瞪口呆，眩晕 1 秒。

**优雅从容** 被动技能 0/0/0
- 任何突发情况都不能打破玛丽高贵从容的仪态。不愿在人前失礼，周围一定范围存在队友时免疫一次虚弱状态（50秒内只能触发一次）。
- 冷静从容，生命上限获得提升。
...
- 尼宝每次对敌方造成伤害或者受到敌方的伤害后，将重置技能的冷却时间，生效8秒内无法再次触发。
...
### 天使杰瑞
**天使祝福** 主动技能 60/60/60
- 天使杰瑞对附近一定范围内被绑上火箭的同伴进行祝福，祝福效果持续30秒，获得祝福效果的同伴被放飞后将会复活。处于复活状态的同伴将会持续暴露自己的位置，如果再次被击倒或陷入可被直接抓取的状态，则直接被淘汰。获得祝福效果的同伴被救下火箭后，将返还该技能一定的冷却时间。
...
- 伤害转移伤害的比例提升至 100% 。
- 如果开启友情庇护时自己的怜悯值为充满状态，则消耗20%的怜悯值并获得免疫虚弱的能力。
...
- 眩晕的持续时间增加，披萨块将解除受伤、失明、反向效果，并且破碎出3个披萨块。
...
```
怒气：当附近队友受到攻击时，将大幅增加怒气，怒气满了之后将进入满怒状态，该状态下，沙包拳头可连续进行 3 次挥拳，大幅减少受到的伤害，并且怒气逐渐释放，直至为0时退出满怒状态，在退出该状态一定时间内，移动速度降低。
```
怒气没满时：
```
...
### 蒙金奇
**勇往直前** 主动技能 35/25/25
- 蒙金奇向前快速行军，期间获得霸体和减伤，可以推开敌人、夹子、碎片等，对接触的敌人造成伤害并击退。施放时可以消耗 60 点士气值造成更多伤害和更强的效果并击落猫咪手中的老鼠。驾驶战车时也可以施放。
- 冷却时间降低。
- 使用后，5秒内可以再次使用一次。

**我，既是军团** 被动技能 0/0/0
- 蒙金奇是军团指挥官，士兵们是他坚实的后盾。学习技能后自然增长士气值，对敌人造成伤害时会提升士气值。虚弱时士气值清空。根据士气值提升其减伤能力。
- 士气值上限获得提升，友方对自身一定范围内敌人造成伤害时蒙金奇也会获得士气值
- 每格士气值额外提供移动速度和生命回复速度，士气自然增长速度提升。

**军团战车** 武器 45/45/35
- 召唤战车加入战场，蒙金奇将暂时藏于车内，由驾驭战车的士兵们接管战场，战车拥有独立的生命，免疫控制，无法使用道具和进行交互，也无法通过任何形式回复生命值。获得额外的战矛投掷技能。施放技能时消耗全部士气值，每点士气值会额外提升战车持续时间。当战车生命耗尽、持续时间结束、蒙金奇主动脱离时，战车会进入自毁倒计时，倒计时结束后，战车爆炸，对范围内所有单位造成伤害。蒙金奇获得临时技能，施放该技能可提前脱离战车。
- 战车拥有更高的生命。
- 冷却时间降低。

### 朵朵
**强能灌注** 主动技能 22/22/22
- 朵朵激发能量为手中道具充能，道具将悬浮在身边等待充能完成，充能完成后，道具将在一段时间内被电流包裹，再次使用技能或到达技能持续时间上限会将道具装载，投掷命中或掉落地面时，会触发一次范围电流伤害。当充能对象为奶酪时，充能状态的奶酪第一次放入洞口时会直接推入一部分。过载状态下将大幅度提高充能速度。
- 电流可以造成更多伤害并造成眩晕。
- 手中没有道具时也可使用，产生一枚电球，电球命中会直接触发电流伤害。过载时，会生成大电球！

**机械身躯** 被动技能 0/0/0
- 朵朵的身躯由绝佳合金打造，可以应对各种复杂环境和状况，减弱太空和水下缺氧对朵朵造成的影响。
- 躯干模块升级，朵朵对大部分减益状态都有较强的抗性，受控制时间缩短，不会因为搬运奶酪而减速。
- 加装主动打击装置，当朵朵生命值降低到一定比例时，施放一次电流保护自己，造成伤害，如果处于过载状态，还会将敌人击退一小段距离。

**能源装置** 武器 25/25/25
- 朵朵加装强力能源装置，可获得爆发能力，但日常能耗也会增加，获得一个能量条，随时间缓慢下降，可通过食物、药水增长。开启能源装置立刻回满能量并获得强化效果。根据指示灯颜色分为数个形态。
```
亏电状态—红色指示灯：移动速度降低，无法施放武器技能。当能量耗尽时，强制原地充电 3 秒，恢复到 80 能量（满值 100 ）。
常态—绿色指示灯：无特殊效果。
过载状态—黄色爆闪指示灯：使用武器技能后获得，短时间内爆发性提高移速，提高投掷物的速度、提高攻击力，过载会加速消耗能量，能量至亏电时自动结束状态，可以主动关闭。
```
- 加装能源重构系统，朵朵进入虚弱时，能源装置向随机方向飞出，当朵朵接触到能源装置时，将进入重构模式，解除虚弱状态、回复少量生命和能量并向周围放电，对周围敌人造成伤害和短暂眩晕效果。能源装置，可以被队友捡起和投掷，投掷命中敌方时会造成少量伤害但会摧毁能源装置持续。散落的能源装置持续一段时间，朵朵会在解除虚弱时重构一个能源装置。
- 强化能量模块，过载状态可以持续更久，开启时，在近身一定范围施放电流，造成伤害和眩晕效果。

### 仙女鼠
**魔镜召唤咒** 主动技能 60/40/40
- 召唤一个持续很久的魔法魔镜，任意玩家都可与其进行交互，通过消耗自己的星星数来进行许愿或者传送。
- 大幅减少冷却时间。
- 许愿的内容将随着许愿次数有概率提高质量。

**魔咒强身** 被动技能 0/0/0
- 不动时将大量减少受到的伤害，但在受到眩晕控制效果时会失去该效果。
- 受到攻击时将进入短时隐身。
- 对敌方造成伤害时，都会额外对敌方施加反向法术效果，持续较短时间。

**仙女棒** 武器 8/2/2
- 仙女鼠赐予所有友方老鼠通过攻击敌方获得星星的能力，同时在学习技能后仙女鼠会随着时间增加自动收集星星（ 8 秒/颗）最多9颗，敌方猫可攻击带有星星的老鼠来夺取他的星星，仙女鼠挥动仙女棒，根据所选的星星数量消耗附近友方和自己的星星，对命中的友方或敌人造成不同的效果。（注：仙女鼠头顶的星星会由自己的星星数+附近队友的星星数进行组合显示）
```
1 星：对碰触的1名友方短时隐身，对碰触的敌方减少健康值和移动速度。
2 星：对碰触的友方短时获得二段跳，对碰触的敌方减少健康值和移动速度。
4 星：对碰触的友方缓慢恢复健康值并解除受伤状态，对碰触的敌方减少健康值和移动速度。
6 星：对碰触的友方使其变成小星星，解除并免疫眩晕和虚弱效果，可释放星星滚滚，向前翻滚一段距离，对碰触的敌方减少健康值和移动速度。
8星：对碰触的敌方猫变成大星星，使其无法通过空间较小的地方，变身后可进行近身攻击和远程吐星星攻击。
```
- 大幅减少冷却时间。
- 提高仙女鼠自身的星星增长速度（ 5 秒/颗）。
